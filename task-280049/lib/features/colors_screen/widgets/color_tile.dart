...
class ColorTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onLongPress: () => widgetModel.copyColorToBuffer(context, color),
      child: FittedBox(
        child: SizedBox(
          height: 140,
          width: 100,
            ...
            Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(color.name, style: Theme.of(context).textTheme.customCaption),
                  ],
                ),
                Row(
                  children: [
                    Text(color.value ?? '', style: Theme.of(context).textTheme.customCaption),
                  ],
                )
              ],
            ),
